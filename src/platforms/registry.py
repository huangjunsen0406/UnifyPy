...
class PackagerRegistry:
    ...
    def register_packager(self, platform: str, format_type: str, packager_class: Type[BasePackager]):
        """
        注册新的打包器
    ...
    def get_packager(self, platform: str, format_type: str) -> Optional[Type[BasePackager]]:
        """
        获取指定格式的打包器类
